...
- **ПРАВИЛО**: При добавлении, удалении или изменении команд Telegram бота ОБЯЗАТЕЛЬНО обновлять раздел "Команды Telegram бота" в `ARCHITECTURE.md`
- **ПРАВИЛО**: Описание команды должно включать назначение, формат ответа и особенности работы
